...
public class Conexion {
	...
	public static void conexion_base (String consulta) throws Throwable{
		...
		try
		{
			...
			while (rset.next())
				
			    {
					...
					nombre = rset.getString("nom_patol");
					descripcion = rset.getString("des_patol");
